...
/**
 * PDO implementation of password reset token repository
 */
class TokenRepositoryPdo implements TokenRepositoryInterface
{
    ...
    public function createToken(int $userId, int $expiryHours = 24): array
    {
        ...
        $sql = "INSERT INTO {$this->table} (user_id, token, expires_at, created_at, updated_at)
                VALUES (:user_id, :token, :expires_at, :created_at, :updated_at)";
